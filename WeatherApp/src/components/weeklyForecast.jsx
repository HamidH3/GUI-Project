...
// import { setSelectedDayInLS } from "../functions/location";
...
//     // const selectedDate = new Date(forecastData.time[index]); // Get the date for the selected day
//     // setSelectedDayInLS(selectedDate);
//     setButtonPopup(true);
